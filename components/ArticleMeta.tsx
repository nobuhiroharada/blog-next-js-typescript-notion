...
import { ArticleMetaPropsType } from '../types/ArticleMetaPropsType'
import { getCover, getDate, getMultiSelect, getText } from '../utils/PagePropertyUtil'

const ArticleMeta: FC<ArticleMetaPropsType> = ({ page }) => {
  return (
    <>
        {/* page cover */}
        <Image
