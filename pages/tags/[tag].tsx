...
import { TagParams } from '../../types/TagParamsType'
import { getMultiSelect } from '../../utils/PagePropertyUtil'
import { TagPropsType } from '../../types/TagPropsType'
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  const { tag } = ctx.params as TagParams
...
const Tag: NextPage<TagPropsType> = ({ pages, tag }) => {
